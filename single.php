    ...
    <main id="mtr-single-main" role="main">
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div id="mtr-single-post-meta">
                <span>
                    <object width="15px" height="15px" type="image/svg+xml" data="<?php echo get_template_directory_uri(); ?>/images/time-colored.svg">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/time-colored.png">
                    </object>
                </span>
                <span class="meta-details"> <?php echo get_the_date() ?></span>
                <span>
                    <object width="15px" height="15px" type="image/svg+xml" data="<?php echo get_template_directory_uri(); ?>/images/comments-colored.svg">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/comments-colored.png">
                    </object>
                </span>
